...
/**
 * <p>Java class for typeSecrptOpList.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="typeSecrptOpList"&gt;
 ...
 * 
 */
@XmlType(name = "typeSecrptOpList")
@XmlEnum
public enum TypeSecrptOpList {
    ...
    public static TypeSecrptOpList fromValue(String v) {
        for (TypeSecrptOpList c: TypeSecrptOpList.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
