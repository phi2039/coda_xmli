...
/**
 * <p>Java class for typeChangeLoggingOperator.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="typeChangeLoggingOperator"&gt;
 ...
 * 
 */
@XmlType(name = "typeChangeLoggingOperator")
@XmlEnum
public enum TypeChangeLoggingOperator {
    ...
    TypeChangeLoggingOperator(String v) {
        value = v;
    }
    ...
    public static TypeChangeLoggingOperator fromValue(String v) {
        for (TypeChangeLoggingOperator c: TypeChangeLoggingOperator.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
