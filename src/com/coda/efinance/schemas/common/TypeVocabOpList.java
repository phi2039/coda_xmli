...
/**
 * <p>Java class for typeVocabOpList.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="typeVocabOpList"&gt;
 ...
 * 
 */
@XmlType(name = "typeVocabOpList")
@XmlEnum
public enum TypeVocabOpList {
    ...
    public static TypeVocabOpList fromValue(String v) {
        for (TypeVocabOpList c: TypeVocabOpList.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
