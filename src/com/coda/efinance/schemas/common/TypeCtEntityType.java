...
/**
 * <p>Java class for typeCtEntityType.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="typeCtEntityType"&gt;
 ...
 *     &lt;enumeration value="reporting_code_1"/&gt;
 *     &lt;enumeration value="reporting_code_2"/&gt;
 *     &lt;enumeration value="reporting_code_3"/&gt;
 ...
 * 
 */
@XmlType(name = "typeCtEntityType")
@XmlEnum
public enum TypeCtEntityType {
    ...
    @XmlEnumValue("reporting_code_1")
    REPORTING_CODE_1("reporting_code_1"),
    @XmlEnumValue("reporting_code_2")
    REPORTING_CODE_2("reporting_code_2"),
    @XmlEnumValue("reporting_code_3")
    REPORTING_CODE_3("reporting_code_3"),
    @XmlEnumValue("store_cat")
    STORE_CAT("store_cat");
    private final String value;

    TypeCtEntityType(String v) {
        value = v;
    }
    ...
    public static TypeCtEntityType fromValue(String v) {
        for (TypeCtEntityType c: TypeCtEntityType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
