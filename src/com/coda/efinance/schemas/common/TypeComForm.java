...
/**
 * <p>Java class for typeComForm.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="typeComForm"&gt;
 ...
 * 
 */
@XmlType(name = "typeComForm")
@XmlEnum
public enum TypeComForm {
    ...
    public static TypeComForm fromValue(String v) {
        for (TypeComForm c: TypeComForm.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
