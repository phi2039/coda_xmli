...
/**
 * <p>Java class for typeChangeLoggingOpStrings.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="typeChangeLoggingOpStrings"&gt;
 ...
 * 
 */
@XmlType(name = "typeChangeLoggingOpStrings")
@XmlEnum
public enum TypeChangeLoggingOpStrings {
    ...
    TypeChangeLoggingOpStrings(String v) {
        value = v;
    }
    ...
    public static TypeChangeLoggingOpStrings fromValue(String v) {
        for (TypeChangeLoggingOpStrings c: TypeChangeLoggingOpStrings.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
