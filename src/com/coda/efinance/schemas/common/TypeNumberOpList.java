...
/**
 * <p>Java class for typeNumberOpList.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="typeNumberOpList"&gt;
 ...
 * 
 */
@XmlType(name = "typeNumberOpList")
@XmlEnum
public enum TypeNumberOpList {
    ...
    /**
     * All except those within a (specified) range.
     * 
     */
    ...
    public static TypeNumberOpList fromValue(String v) {
        for (TypeNumberOpList c: TypeNumberOpList.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
