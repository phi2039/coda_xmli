...
/**
 * <p>Java class for typeCtAccessOp.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="typeCtAccessOp"&gt;
 ...
 * 
 */
@XmlType(name = "typeCtAccessOp")
@XmlEnum
public enum TypeCtAccessOp {
    ...
    public static TypeCtAccessOp fromValue(String v) {
        for (TypeCtAccessOp c: TypeCtAccessOp.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
