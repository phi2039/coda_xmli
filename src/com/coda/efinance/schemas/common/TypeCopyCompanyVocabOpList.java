...
/**
 * <p>Java class for typeCopyCompanyVocabOpList.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="typeCopyCompanyVocabOpList"&gt;
 ...
 * 
 */
@XmlType(name = "typeCopyCompanyVocabOpList")
@XmlEnum
public enum TypeCopyCompanyVocabOpList {
    ...
    TypeCopyCompanyVocabOpList(String v) {
        value = v;
    }
    ...
    public static TypeCopyCompanyVocabOpList fromValue(String v) {
        for (TypeCopyCompanyVocabOpList c: TypeCopyCompanyVocabOpList.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
