...
/**
 * <p>Java class for typeDataMetadataSetTypes.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="typeDataMetadataSetTypes"&gt;
 ...
 * 
 */
@XmlType(name = "typeDataMetadataSetTypes")
@XmlEnum
public enum TypeDataMetadataSetTypes {
    ...
    TypeDataMetadataSetTypes(String v) {
        value = v;
    }
    ...
    public static TypeDataMetadataSetTypes fromValue(String v) {
        for (TypeDataMetadataSetTypes c: TypeDataMetadataSetTypes.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
