...
/**
 * <p>Java class for typeWflowHdrStatusb.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="typeWflowHdrStatusb"&gt;
 ...
 * 
 */
@XmlType(name = "typeWflowHdrStatusb")
@XmlEnum
public enum TypeWflowHdrStatusb {
    ...
    public static TypeWflowHdrStatusb fromValue(String v) {
        for (TypeWflowHdrStatusb c: TypeWflowHdrStatusb.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
