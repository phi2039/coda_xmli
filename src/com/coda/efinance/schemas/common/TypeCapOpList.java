...
/**
 * <p>Java class for typeCapOpList.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="typeCapOpList"&gt;
 ...
 * 
 */
@XmlType(name = "typeCapOpList")
@XmlEnum
public enum TypeCapOpList {
    ...
    public static TypeCapOpList fromValue(String v) {
        for (TypeCapOpList c: TypeCapOpList.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
