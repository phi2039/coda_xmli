...
/**
 * <p>Java class for typeCtElementLevel.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="typeCtElementLevel"&gt;
 ...
 * 
 */
@XmlType(name = "typeCtElementLevel")
@XmlEnum
public enum TypeCtElementLevel {
    ...
    public static TypeCtElementLevel fromValue(String v) {
        for (TypeCtElementLevel c: TypeCtElementLevel.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
