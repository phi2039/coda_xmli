...
/**
 * <p>Java class for typeDataMetadataTypes.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="typeDataMetadataTypes"&gt;
 ...
 * 
 */
@XmlType(name = "typeDataMetadataTypes")
@XmlEnum
public enum TypeDataMetadataTypes {
    ...
    TypeDataMetadataTypes(String v) {
        value = v;
    }
    ...
    public static TypeDataMetadataTypes fromValue(String v) {
        for (TypeDataMetadataTypes c: TypeDataMetadataTypes.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
