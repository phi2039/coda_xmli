...
/**
 * <p>Java class for typeChangeLoggingOpNumbers.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="typeChangeLoggingOpNumbers"&gt;
 ...
 * 
 */
@XmlType(name = "typeChangeLoggingOpNumbers")
@XmlEnum
public enum TypeChangeLoggingOpNumbers {
    ...
    TypeChangeLoggingOpNumbers(String v) {
        value = v;
    }
    ...
    public static TypeChangeLoggingOpNumbers fromValue(String v) {
        for (TypeChangeLoggingOpNumbers c: TypeChangeLoggingOpNumbers.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
