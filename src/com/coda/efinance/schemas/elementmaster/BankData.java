 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Bank" type="{http://www.coda.com/efinance/schemas/elementmaster}BankElement" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    implements Serializable
{
    ...
    protected List<BankElement> bank;
     ...
     * 
     */
    public List<BankElement> getBank() {
        if (bank == null) {
            bank = new ArrayList<BankElement>();
        }
        return this.bank;
    }
