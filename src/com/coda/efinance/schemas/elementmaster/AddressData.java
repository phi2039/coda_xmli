 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Address" type="{http://www.coda.com/efinance/schemas/elementmaster}AddressElement" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    implements Serializable
{
    ...
    protected List<AddressElement> address;
    ...
    public List<AddressElement> getAddress() {
        if (address == null) {
            address = new ArrayList<AddressElement>();
        }
        return this.address;
    }
