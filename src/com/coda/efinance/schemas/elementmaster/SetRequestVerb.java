 ...
 * 
 * <p>Java class for SetRequestVerb complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="SetRequestVerb"&gt;
 *   &lt;complexContent&gt;
 *     &lt;extension base="{http://www.coda.com/efinance/schemas/common}MultiCompanyRequestVerb"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="Request" type="{http://www.coda.com/efinance/schemas/elementmaster}SetRequest" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "SetRequestVerb", propOrder = {
    "request"
})
public class SetRequestVerb
    extends MultiCompanyRequestVerb
    implements Serializable
{

    @XmlElement(name = "Request", required = true)
    protected List<SetRequest> request;
     ...
     * 
     */
    public List<SetRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<SetRequest>();
        }
        return this.request;
    }
